...
### Strategy ###
class EmaCOCross_trailing(SignalStrategy,
               TrailingStrategy):
    n1 = 5
    n2 = 5
    ...
    def init(self):
        ...
        ema2 = self.I(ta.EMA, self.data.Open, self.n2)
...
for i in assets:
    ...
    bt = Backtest(df, EmaCOCross_trailing, cash=initial_cash, commission=exchange_commission,
